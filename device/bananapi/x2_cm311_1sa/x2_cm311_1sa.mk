...
$(call inherit-product, device/bananapi/common/products/$(PRODUCT_TYPE)/product_$(PRODUCT_TYPE).mk)
...
PRODUCT_NAME := x2_cm311_1sa
PRODUCT_DEVICE := x2_cm311_1sa
PRODUCT_BRAND := XingYi_x2
PRODUCT_MODEL := x2_cm311_1sa
...
GAPPS_EXCLUDED_PACKAGES += GoogleBackupTransport  ConfigUpdater GoogleContactsSyncAdapter Backdrop Katniss GoogleCalendarSyncAdapter GoogleOneTimeInitializer
