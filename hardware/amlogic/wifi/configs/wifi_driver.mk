...
uwe5621ds:
	$(MAKE) -C $(shell pwd)/$(PRODUCT_OUT)/obj/KERNEL_OBJ  M=$(shell pwd)/hardware/wifi/unisoc/uwe5621ds/BSP ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(CROSS_COMPILE)  CFG_AML_WIFI_DEVICE_UWE5621=y
	$(MAKE) -C $(shell pwd)/$(PRODUCT_OUT)/obj/KERNEL_OBJ  M=$(shell pwd)/hardware/wifi/unisoc/uwe5621ds/WIFI ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(CROSS_COMPILE)  CFG_AML_WIFI_DEVICE_UWE5621=y
	cp $(shell pwd)/hardware/wifi/unisoc/uwe5621ds/BSP/uwe5621_bsp_sdio.ko  $(TARGET_OUT)/
	cp $(shell pwd)/hardware/wifi/unisoc/uwe5621ds/WIFI/sprdwl_ng.ko  $(TARGET_OUT)/
multiwifi:
