...
public class UserScriptsBootanimation3 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootanimation3 newInstance() {
        return new UserScriptsBootanimation3();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("unzip /system/media/tv_script/bootanimation bootanimation_3.zip -o -q -d /system/media/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("mv -f /system/media/bootanimation_3.zip /system/media/bootanimation.zip", true);
        super.onPreferenceTreeClick(preference);
