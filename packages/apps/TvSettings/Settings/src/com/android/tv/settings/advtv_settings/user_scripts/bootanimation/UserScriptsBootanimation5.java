...
public class UserScriptsBootanimation5 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootanimation5 newInstance() {
        return new UserScriptsBootanimation5();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("unzip /system/media/tv_script/bootanimation bootanimation_5.zip -o -q -d /system/media/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("mv -f /system/media/bootanimation_5.zip /system/media/bootanimation.zip", true);
        super.onPreferenceTreeClick(preference);
