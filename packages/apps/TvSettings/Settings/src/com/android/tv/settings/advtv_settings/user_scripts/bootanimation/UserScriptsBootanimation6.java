...
public class UserScriptsBootanimation6 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootanimation6 newInstance() {
        return new UserScriptsBootanimation6();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("unzip /system/media/tv_script/bootanimation bootanimation_6.zip -o -q -d /system/media/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("mv -f /system/media/bootanimation_6.zip /system/media/bootanimation.zip", true);
        super.onPreferenceTreeClick(preference);
