...
public class UserScriptsBootanimationOff extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootanimationOff newInstance() {
        return new UserScriptsBootanimationOff();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("rm -rf /system/media/bootanimation.zip", true);
        super.onPreferenceTreeClick(preference);
