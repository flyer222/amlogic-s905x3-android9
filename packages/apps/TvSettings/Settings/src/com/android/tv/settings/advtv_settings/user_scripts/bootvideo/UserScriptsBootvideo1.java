...
public class UserScriptsBootvideo1 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootvideo1 newInstance() {
        return new UserScriptsBootvideo1();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("unzip /system/media/tv_script/bootvideo bootvideo_1 -o -q -d /vendor/etc/", true);
        super.onPreferenceTreeClick(preference);
