...
public class UserScriptsBootvideo2 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootvideo2 newInstance() {
        return new UserScriptsBootvideo2();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("unzip /system/media/tv_script/bootvideo bootvideo_2 -o -q -d /vendor/etc/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("mv -f /vendor/etc/bootvideo_2 /vendor/etc/bootvideo", true);
        super.onPreferenceTreeClick(preference);
