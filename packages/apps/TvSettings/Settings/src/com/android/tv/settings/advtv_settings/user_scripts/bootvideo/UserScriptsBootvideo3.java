...
public class UserScriptsBootvideo3 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootvideo3 newInstance() {
        return new UserScriptsBootvideo3();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("unzip /system/media/tv_script/bootvideo bootvideo_3 -o -q -d /vendor/etc/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("mv -f /vendor/etc/bootvideo_3 /vendor/etc/bootvideo", true);
        super.onPreferenceTreeClick(preference);
