...
public class UserScriptsBootvideo4 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootvideo4 newInstance() {
        return new UserScriptsBootvideo4();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("unzip /system/media/tv_script/bootvideo bootvideo_4 -o -q -d /vendor/etc/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("mv -f /vendor/etc/bootvideo_4 /vendor/etc/bootvideo", true);
        super.onPreferenceTreeClick(preference);
