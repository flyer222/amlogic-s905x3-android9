...
public class UserScriptsBootvideo6 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootvideo6 newInstance() {
        return new UserScriptsBootvideo6();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("unzip /system/media/tv_script/bootvideo bootvideo_6 -o -q -d /vendor/etc/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("mv -f /vendor/etc/bootvideo_6 /vendor/etc/bootvideo", true);
        super.onPreferenceTreeClick(preference);
