...
public class UserScriptsBootvideo7 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootvideo7 newInstance() {
        return new UserScriptsBootvideo7();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("unzip /system/media/tv_script/bootvideo bootvideo_7 -o -q -d /vendor/etc/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("mv -f /vendor/etc/bootvideo_7 /vendor/etc/bootvideo", true);
        super.onPreferenceTreeClick(preference);
