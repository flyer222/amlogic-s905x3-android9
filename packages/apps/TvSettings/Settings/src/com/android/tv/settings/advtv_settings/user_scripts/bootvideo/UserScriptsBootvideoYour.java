...
public class UserScriptsBootvideoYour extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsBootvideoYour newInstance() {
        return new UserScriptsBootvideoYour();
    }
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        createPreferenceScreen.setTitle(R.string.bootvideo_your_chooser);
        getString(R.string.bootvideo_your_chooser);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("cp -r /sdcard/UpdateAdvtv/*.mp4 /vendor/etc/bootvideo_1", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("mv -f /vendor/etc/bootvideo_1 /vendor/etc/bootvideo", true);
        super.onPreferenceTreeClick(preference);
