...
public class UserScriptsLogo4 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsLogo4 newInstance() {
        return new UserScriptsLogo4();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        ShellUtils.execCommand("unzip /system/media/tv_script/logo logo_4.img -o -q -d /data/media/0/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("dd if=/data/media/0/logo_4.img of=/dev/block/logo", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("rm -rf /data/media/0/logo_4.img", true);
        super.onPreferenceTreeClick(preference);
