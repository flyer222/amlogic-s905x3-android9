...
public class UserScriptsLogo6 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsLogo6 newInstance() {
        return new UserScriptsLogo6();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        ShellUtils.execCommand("unzip /system/media/tv_script/logo logo_6.img -o -q -d /data/media/0/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("dd if=/data/media/0/logo_6.img of=/dev/block/logo", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("rm -rf /data/media/0/logo_6.img", true);
        super.onPreferenceTreeClick(preference);
