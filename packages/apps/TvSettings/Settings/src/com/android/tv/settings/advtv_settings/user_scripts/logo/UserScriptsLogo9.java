...
public class UserScriptsLogo9 extends SettingsPreferenceFragment {
    private Preference mRunNow;

    public static UserScriptsLogo9 newInstance() {
        return new UserScriptsLogo9();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        ShellUtils.execCommand("unzip /system/media/tv_script/logo logo_9.img -o -q -d /data/media/0/", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("dd if=/data/media/0/logo_9.img of=/dev/block/logo", true);
        super.onPreferenceTreeClick(preference);
        ShellUtils.execCommand("rm -rf /data/media/0/logo_9.img", true);
        super.onPreferenceTreeClick(preference);
